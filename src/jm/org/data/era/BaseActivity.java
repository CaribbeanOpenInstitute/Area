...
public class BaseActivity extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		/*
		 * if(!area.isServiceRunning) { startService(new Intent(this,
		 * AreaService.class)); area.isServiceRunning = true; }
		 */
	 ...
	 * Log.d(TAG, "AreaService connected"); //Toast.makeText(, "Connected",
	 * Toast.LENGTH_SHORT).show(); }
	 * 
	 * @Override public void onServiceDisconnected(ComponentName className) {
	 * areaService = null; } };
	 * 
	 * void doBindService() { bindService(new Intent(this, AreaService.class),
