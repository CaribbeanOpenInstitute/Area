...
public class Soundex implements StringEncoder {
	 ...
	 */
	private static final char[] US_ENGLISH_MAPPING = US_ENGLISH_MAPPING_STRING
			.toCharArray();
	...
	/**
	 * Creates a soundex instance using the given mapping. This constructor can
	 * be used to provide an internationalized mapping for a non-Western
	 * character set.
	 * 
	 * Every letter of the alphabet is "mapped" to a numerical value. This char
	 * array holds the values to which each letter is mapped. This
	 ...
	 * constructor can be used to customize the mapping, and/or possibly provide
