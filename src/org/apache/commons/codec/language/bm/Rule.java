 ...
 * <blockquote>org/apache
 * /commons/codec/language/bm/${NameType#getName}_${RuleType
 * #getName}_${language}.txt</blockquote>
 * <p>
...
public class Rule {
			...
			if (inMultilineComment) {
				...
				if (line.startsWith(ResourceConstants.EXT_CMT_START)) {
					...
					if (line.startsWith(HASH_INCLUDE)) {
						...
						if (incl.contains(" ")) {
							throw new IllegalArgumentException(
									"Malformed import statement '" + rawLine
											+ "' in " + location);
						} else {
	 ...
	 * position. It is a match if the <code>lContext</code> matches
	 * <code>input</code> up to <code>i</code>, <code>pattern</code> matches at
	 * i and <code>rContext</code> matches from the end of the match of
	...
	public boolean patternAndContextMatches(CharSequence input, int i) {
		...
		if (!input.subSequence(i, ipl).equals(this.pattern)) {
			return false;
				...
				.isMatch(input.subSequence(ipl, input.length()))) {
			return false;
		}
