 ...
 */
public class Lang {
	// Implementation note: This class is divided into two sections. The first
	// part is a static factory interface that
	// exposes the LANGUAGE_RULES_RN resource as a Lang instance. The second
	// part is the Lang instance methods that
	 ...
	 * @return a Lang encapsulating the language guessing rules for that name
	 *         type
	 */
	 ...
	 * {@link #instance(NameType)} method. You will only need to call this
	...
	public static Lang loadFromResource(String languageRulesResourceName,
		...
		while (scanner.hasNextLine()) {
			...
			if (inExtendedComment) {
				// check for closing comment marker, otherwise discard doc
				// comment line
	 ...
	 * @param text
	 *            the word
	 * @return the language that the word originates from or
	 *         {@link Languages#ANY} if there was no unique match
	 */
	 ...
	 * @param input
	 *            the word
	 * @return a Set of Strings of language names that are potential matches for
	 *         the input word
	 */
