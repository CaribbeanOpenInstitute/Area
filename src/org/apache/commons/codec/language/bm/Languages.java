...
public class Languages {
	// Iimplementation note: This class is divided into two sections. The first
	...
	// this set fo supported languages.
	...
	private static final Map<NameType, Languages> LANGUAGES = new EnumMap<NameType, Languages>(
			NameType.class);
	...
	public static Languages getInstance(String languagesResourceName) {
		...
		InputStream langIS = Languages.class.getClassLoader()
				.getResourceAsStream(languagesResourceName);

		if (langIS == null) {
			throw new IllegalArgumentException(
					"Unable to resolve required resource: "
	...
	private static String langResourceName(NameType nameType) {
		return String.format(
				"org/apache/commons/codec/language/bm/%s_languages.txt",
				nameType.getName());
	}
