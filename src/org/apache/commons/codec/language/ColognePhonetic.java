 ...
 * replaced by their phonetic code according to the following table.
 * <table border="1">
 * <tbody>
 * <tr>
 * <th>Letter</th>
 ...
 * >Wikipedia (de): K&ouml;lner Phonetik -- Buchstabencodes</a>)</i></small>
 * </p>
 * 
 * <h4>Example:</h4>
 * 
 * {@code "M}&uuml;{@code ller-L}&uuml;
 * {@code denscheidt" => "MULLERLUDENSCHEIDT" => "6005507500206880022"}
 * 
 * </li>
 * 
 * <li>
 ...
 * <li>
 * <h3>Step 3:</h3>
 * Removal of all codes "0" except at the beginning. This means that two or more
 * identical consecutive digits can occur if they occur after removing the "0"
 * digits.
 * 
 * <h4>Example:</h4>
...
public class ColognePhonetic implements StringEncoder {
	...
	public String colognePhonetic(String text) {
		...
		while (rightLength > 0) {
			...
			if (arrayContains(new char[] { 'A', 'E', 'I', 'J', 'O', 'U', 'Y' },
					chr)) {
				code = '0';
				...
				if (lastCode == '/') {
					if (arrayContains(new char[] { 'A', 'H', 'K', 'L', 'O',
							'Q', 'R', 'U', 'X' }, nextChar)) {
						code = '4';
					} else {
						code = '8';
