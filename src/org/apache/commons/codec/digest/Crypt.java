...
public class Crypt {
	 ...
	 * cut at the maximum length of if a "$" sign is encountered. It is
	 ...
	 * </pre>
	 * <p>
	 * The resulting string starts with the marker string ($6$), continues with
	 * the salt value and ends with a "$" sign followed by the actual hash
