...
public class UnixCrypt {
	...
	private static final int COV2CHAR[] = { 46, 47, 48, 49, 50, 51, 52, 53, 54,
	 ...
	 *            plaintext password
	 * @param salt
	 *            a two character string drawn from [a-zA-Z0-9./] or null for a
	 *            random one
	 * @return a 13 character string starting with the salt string
	...
	private static int dEncrypt(int el, int r, int s, int e0, int e1,
			int sArr[]) {
		int v = r ^ r >>> 16;
		int u = v & e0;
		v &= e1;
		...
		t = t >>> 4 | t << 28;
		el ^= SPTRANS[1][t & 0x3f] | SPTRANS[3][t >>> 8 & 0x3f]
