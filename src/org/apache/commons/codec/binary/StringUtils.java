...
public class StringUtils {
	 ...
	 *            The bytes to be decoded into characters, may be {@code null}
	 * @return A new <code>String</code> decoded from the specified array of
	 *         bytes using the ISO-8859-1 charset, or {@code null} if the input
	 ...
	 *            The bytes to be decoded into characters
	 * @return A new <code>String</code> decoded from the specified array of
	 *         bytes using the US-ASCII charset, or {@code null} if the input
	 *         byte array was {@code null}.
	 * @throws NullPointerException
	 *             Thrown if {@link Charsets#US_ASCII} is not initialized, which
	 *             should never happen since it is required by the Java platform
	 ...
	 *            The bytes to be decoded into characters
	 * @return A new <code>String</code> decoded from the specified array of
	 *         bytes using the UTF-16 charset or {@code null} if the input byte
	 *         array was {@code null}.
	 * @throws NullPointerException
	 *             Thrown if {@link Charsets#UTF_16} is not initialized, which
	 *             should never happen since it is required by the Java platform
	 ...
	 *            The bytes to be decoded into characters
	 * @return A new <code>String</code> decoded from the specified array of
	 *         bytes using the UTF-16BE charset, or {@code null} if the input
	 *         byte array was {@code null}.
	 * @throws NullPointerException
	 *             Thrown if {@link Charsets#UTF_16BE} is not initialized, which
	 *             should never happen since it is required by the Java platform
	 ...
	 *            The bytes to be decoded into characters
	 * @return A new <code>String</code> decoded from the specified array of
	 *         bytes using the UTF-16LE charset, or {@code null} if the input
	 *         byte array was {@code null}.
	 * @throws NullPointerException
	 *             Thrown if {@link Charsets#UTF_16LE} is not initialized, which
	 *             should never happen since it is required by the Java platform
