...
public class Base32InputStream extends BaseNCodecInputStream {
	...
	/**
	 * Creates a Base32InputStream such that all data read is Base32-decoded
	 ...
	 * Base32-encoded or Base32-decoded from the original provided InputStream.
	 * 
	 * @param in
	 *            InputStream to wrap.
	 * @param doEncode
	 ...
	 */
	public Base32InputStream(InputStream in, boolean doEncode, int lineLength,
			byte[] lineSeparator) {
